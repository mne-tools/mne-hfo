...
- Added initial implementation of :func:`mne_hfo.HilbertDetector` by `Patrick Myers`_ (:gh:`23`)
...
- Separated postprocessing step into two discrete steps :func:`mne_hfo.base.Detector._threshold_statistic` and :func:`mne_hfo.base.Detector._post_process_ch_hfos` by `Patrick Myers`_ (:gh:`23`)
