...
mne_bin_dir = op.abspath(op.dirname(mne_hfo.__file__))
...
def print_help():
    """Print the help."""
    print("Usage : mne_hfo command options\n")
    print("Accepted commands :\n")
    for c in valid_commands:
        print("\t- %s" % c)
    print("\nExample : mne_hfo raw_to_bids --subject_id sub01 --task rest",
...
def main():
    ...
    if len(sys.argv) == 1:
        ...
        print("MNE-BIDS %s" % mne_hfo.__version__)
