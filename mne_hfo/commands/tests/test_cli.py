...
from mne_hfo.commands import (mne_bids_raw_to_bids,
                              mne_bids_cp,
...
from mne_hfo import BIDSPath, read_raw_bids, write_raw_bids
...
def test_mark_bad_chanels_single_file(tmpdir):
    """Test mne_hfo mark_bad_channels."""
...
def test_calibration_to_bids(tmpdir):
    """Test mne_hfo calibration_to_bids."""
...
def test_crosstalk_to_bids(tmpdir):
    """Test mne_hfo crosstalk_to_bids."""
