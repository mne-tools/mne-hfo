...
from mne_hfo import (BIDSPath, read_raw_bids, write_raw_bids, inspect_dataset,
                     write_meg_calibration, write_meg_crosstalk)
import mne_hfo.inspect
from mne_hfo.read import _from_tsv
...
def test_inspect_single_file(tmp_path, save_changes):
    ...
    raw_fig = mne_hfo.inspect._global_vars['raw_fig']
    ...
    fig_dialog = mne_hfo.inspect._global_vars['dialog_fig']
